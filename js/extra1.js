...
// pricePerItem = 3500;
// Переменной productName присвоено новое значение - строка 'Ремонтный дроид'./ // 2000
...
// Задание
// Функция calculateTotalPrice считает и возвращает общую сумму покупки. Она объявляет два параметра, значения которых будут задаваться во время её вызова.
...
// Пиши код ниже этой строки(a = a + 2;
b = b - 4;
c = c * 3;
d = d / 10;)
a += 2;
...
Вызов функции formatMessage('Nunc sed turpis a felis in nunc fringilla', 41) возвращает 'Nunc sed turpis a felis in nunc fringilla'.function formatMessage(message, maxLength) {
  let result;
// Пиши код ниже этой строки
...
function checkForSpam(message) {
 ...
 let messageForCheck = message.toLowerCase();
  result = messageForCheck.includes('sale') || messageForCheck.includes('spam');
  // Пиши код выше этой строки
  return result;
}
