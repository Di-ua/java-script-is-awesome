...
// первый вариант, но не работает почему-то
...
// Функция проверяет ее на содержание слов spam и sale.Если нашли запрещенное слово то функция возвращает true, если запрещенных слов нет функция возвращает false.Слова в строке могут быть в произвольном регистре.
...
//   let total = 0;
//   // Write code under this line
//   for (var i = 0; i < array.length; i += 1) total += array[i];
//   return total;
// }
